...
#x1, y1 = solution_dim_2(g, 0, 0, 0, 3, 0.05, methode='euler')
#x2, y2 = solution_dim_2(g, 0, 0, 0, 3, 0.01, methode='euler')
#x3, y3 = solution_dim_2(g, 0, 0, 0, 3, 0.001, methode='euler')
#xs, ys = sol_exacte_dim_2(g, 0, 0, 0, 3, 0.001)

# # Traçage des courbes
#traces.trace((x1, y1, 'Euler pas de 0.05'), (x2, y2, 'Euler pas de 0.01'), (x3, y3, 'Euler pas de 0.001'),sol=(xs, ys))
...
# # Définition des courbes que l'on veut tracer
#x1, y1 = solution_dim_n(g, [0, 0, 0], 0, 50, 0.5, methode='rk4')
#x2, y2 = solution_dim_n(g, [0, 0, 0], 0, 50, 0.1, methode='rk4')
#x3, y3 = solution_dim_n(g, [0, 0, 0], 0, 50, 0.01, methode='euler')
#xs, ys = sol_exacte_dim_n(g, [0, 0, 0], 0, 50, 0.01)
...
# Définition des courbes que l'on veut tracer
#x1, y1 = solution_dim_n(g, [pi/3, 0], 0, 3, 0.001, methode='euler')
#x2, y2 = solution_dim_n(g, [0.5,3], -15, 1, 0.001, methode='rk4')

#xs, ys = sol_exacte_dim_n(g, [0.5,3], -15, 1, 0.001)

# Traçage des courbes
#traces.trace((x2, y2, 'RK4 pas de 0.001'), sol=(xs, ys))